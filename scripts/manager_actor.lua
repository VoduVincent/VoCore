...
function getActorRecordTypeFromPath(sActorNodePath)
	...
	for sActorRecordType, _ in pairs(_tActorRecordTypes) do
		for _, vMapping in ipairs(LibraryData.getMappings(sActorRecordType)) do
			if StringManager.startsWith(sActorNodePath, vMapping .. ".") then
				return sActorRecordType;
			end
		end
	end
